...
contract SimpleStaking {
    ...
    function stakeTokens(Token token, uint256 amount) public timestampIsSet noReentrant {
    ...
    function unstakeTokens(Token token, uint256 amount) public timestampIsSet noReentrant {
